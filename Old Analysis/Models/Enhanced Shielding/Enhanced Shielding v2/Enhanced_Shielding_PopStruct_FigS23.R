...
out1c$cumV.cumIv[out1c$time == 71+(365)]-out1c$cumV.cumIv[out1c$time == 71]
...
plot <- ggarrange(pinf96, pinf84,
                  
                  pinf72,  pinf60,
                  
                  ncol = 2, nrow = 2, 
                  heights = c(1, 1.15), common.legend = TRUE, legend = "bottom",
                  labels = c("A", "B", "C", "D"), font.label = c(size = 20))

#Anti-Aliasing in Plots - Can Ignore 
setwd("C:/Users/amorg/Documents/PhD/nCoV Work/Figures/Enhanced Shielding/New")
ggsave(plot, filename = "FigS3.png", dpi = 300, type = "cairo",

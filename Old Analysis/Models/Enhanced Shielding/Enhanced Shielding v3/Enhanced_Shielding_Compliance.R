...
parms = c(gamma = 1/(GenTime(3.3,2.8)), 
          ...
          tstart1 = 71, 
          tdur = (6*7), 
          comp = 1) #CAN VARY THIS - DEPENDING ON FACTOR EXPLORED
...
out1$Iv[which(diff(sign(diff(out1$Iv)))==-2)+1][2]
...
parms = c(gamma = 1/(GenTime(3.3,2.8)), 
          ...
          tstart1 = 71, 
          tdur = (6*7), 
          comp = 0.75) #CAN VARY THIS - DEPENDING ON FACTOR EXPLORED
...
parms = c(gamma = 1/(GenTime(3.3,2.8)), 
          ...
          tstart1 = 71, 
          tdur = (6*7), 
          comp = 0.5) #CAN VARY THIS - DEPENDING ON FACTOR EXPLORED
...
parms = c(gamma = 1/(GenTime(3.3,2.8)), 
          ...
          tstart1 = 71, 
          tdur = (6*7), 
          comp = 0.25) #CAN VARY THIS - DEPENDING ON FACTOR EXPLORED
...
parms = c(gamma = 1/(GenTime(3.3,2.8)), 
          ...
          tstart1 = 71, 
          tdur = (6*7), 
          comp = 0) #CAN VARY THIS - DEPENDING ON FACTOR EXPLORED
...
#Anti-Aliasing in Plots - Can Ignore 
setwd("C:/Users/amorg/Documents/PhD/nCoV Work/Figures/Enhanced Shielding/New")
ggsave(plot, filename = "AlternativeFig9.png", dpi = 300, type = "cairo",

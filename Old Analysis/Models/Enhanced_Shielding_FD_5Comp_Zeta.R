...
p1 <- ggplot(output, aes(x = zetaseq, y = HeightSecPeak)) + theme_bw() + geom_line(size = 1.02, col = "red") + 
...
p1 <- ggplot(statzeta, aes(x = DayImmune, y = value)) + geom_line(size = 1.02, stat = "identity", col = "darkblue") + theme_bw() +

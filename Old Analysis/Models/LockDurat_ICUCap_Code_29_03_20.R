...
combdatainf <- rbind(data.frame("WeekDuration" = "3 Weeks", "Time" = c(seq(-125,0), seq(1,730-125)), "Value" = stats1$Infec[stats1$WeekDuration == "3 Weeks"]),
                  data.frame("WeekDuration" = "12 Weeks", "Time" = c(seq(-125,0), seq(1,730-125)), "Value" = stats1$Infec[stats1$WeekDuration == "12 Weeks"]))
combdatainf$WeekDuration <- factor(combdatainf$WeekDuration, levels = unique(combdatainf$WeekDuration))

combdatarec <- rbind(data.frame("WeekDuration" = "3 Weeks", "Time" = c(seq(-125,0), seq(1,730-125)), "Value" = stats1$Recov[stats1$WeekDuration == "3 Weeks"]),
                   data.frame("WeekDuration" = "12 Weeks", "Time" = c(seq(-125,0), seq(1,730-125)), "Value" = stats1$Recov[stats1$WeekDuration == "12 Weeks"]))
combdatarec$WeekDuration <- factor(combdatarec$WeekDuration, levels = unique(combdatarec$WeekDuration))

combdatabeta <- rbind(data.frame("WeekDuration" = "3 Week Intervention", "Time" = c(seq(-125,0), seq(1,730-125)), "Value" = stats1$Beta[stats1$WeekDuration == "3 Weeks"]),
                      data.frame("WeekDuration" = "12 Week Intervention", "Time" = c(seq(-125,0), seq(1,730-125)), "Value" = stats1$Beta[stats1$WeekDuration == "12 Weeks"]))

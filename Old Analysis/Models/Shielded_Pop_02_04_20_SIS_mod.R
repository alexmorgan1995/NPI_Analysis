...
beta1 <- function(time, tstart1, tdur1, beta1_2) {
  ifelse((time >= tstart1 & time <= tstart1+tdur1), #Phase 1
         0.064,
         ifelse((time >= tstart1+tdur1 & time <= 730), #Phase 2
                beta1_2,
...
plot(beta1(seq(0,730), 100, (6*7), 0.064))
...
SIS <- function(time, state, parameters) {
  with(as.list(c(state, parameters)), {
    dSv = - beta1(time, tstart1, tdur1, beta1_2)*Iv*Sv -beta1(time, tstart1, tdur1, beta1_2)*Inv*Sv + gamma*Iv
    
    dSnv = - beta2(time,tstart1,tdur1,tdur2)*Inv*Snv - beta2(time,tstart1,tdur1,tdur2)*Iv*Snv  + gamma*Inv
    
    dIv = beta1(time, tstart1, tdur1, beta1_2)*Iv*Sv + beta1(time, tstart1, tdur1, beta1_2)*Inv*Sv - gamma*Iv
    
    dInv =  beta2(time,tstart1,tdur1,tdur2)*Inv*Snv + beta2(time,tstart1,tdur1,tdur2)*Iv*Snv - gamma*Inv

    dCv = beta1(time, tstart1, tdur1, beta1_2)*Iv*Sv + beta1(time, tstart1, tdur1, beta1_2)*Inv*Sv
...
out1$beta1 <- beta1(seq(0,730), 100, (6*7), 0)
...
SIRss <- function(time, state, parameters) {
  with(as.list(c(state, parameters)), {
    dSv = - beta1(time, tstart1, tdur1, beta1_2)*Iv*Sv - beta1(time, tstart1, tdur1, beta1_2)*Inv*Sv 
...
out2$beta1 <- beta1(seq(0,730), 100, (6*7), 0)

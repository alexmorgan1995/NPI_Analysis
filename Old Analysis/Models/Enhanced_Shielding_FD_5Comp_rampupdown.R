...
#GGARRANGE
ggarrange(pinf12, NULL, pinf6, NULL, pinf18, nrow = 5, ncol = 1, align = "v", heights = c(0.5, -0.03, 0.5, -0.03, 0.6), labels = c("A"), font.label = c(size = 20) )
...
#GGARRANGE
ggarrange(pinf12down, NULL, pinf6down, NULL, pinf18down, nrow = 5, ncol = 1, align = "v", heights = c(0.5, -0.03, 0.5, -0.03, 0.6), labels = c("B"), font.label = c(size = 20) )

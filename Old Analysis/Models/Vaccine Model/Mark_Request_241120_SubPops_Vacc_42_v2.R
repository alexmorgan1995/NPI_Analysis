...
combframe <- data.frame(cbind("time" = out$time, 
...
datatext <- data.frame(x = c(500, 500, 500, 500), y = c(0.148, 0.140, 0.132, 0.124), 
...
#ggsave(pcomb, filename = "vacc_scenario_seq_270.png", dpi = 300, type = "cairo", width = 10, height = 14, units = "in")

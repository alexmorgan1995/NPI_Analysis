...
if(parms[["simp"]] == "No") {
  data_i$group <- "Coverage_90_seq"
} else{
  data_i$group <- paste0("Coverage_90_simple_", parms[["timing"]])
  paste0("Coverage_90_simple_", parms[["timing"]])
}

if(parms[["simp"]] == "No") {
  write.csv(data_i,'Coverage_90_seq.csv')
} else{
  write.csv(data_i,paste0("Coverage_90_simple_", parms[["timing"]] ,".csv"))
}

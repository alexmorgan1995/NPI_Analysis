...
if(parms[["simp"]] == "No") {
  data_i$group <- "Transblock_90_seq"
} else{
  data_i$group <- paste0("Transblock_90_simple_", parms[["timing"]])
  paste0("Transblock_90_simple_", parms[["timing"]])
}

if(parms[["simp"]] == "No") {
  write.csv(data_i,'Transblock_90_seq.csv')
} else{
  write.csv(data_i,paste0("Transblock_90_simple_", parms[["timing"]] ,".csv"))
}

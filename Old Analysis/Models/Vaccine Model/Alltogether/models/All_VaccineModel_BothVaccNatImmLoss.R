...
if(parms[["simp"]] == "No") {
  data_i$group <- "BothNatVacImmLoss_seq"
} else{
  data_i$group <- paste0("BothNatVacImmLoss_simple_", parms[["timing"]])
  paste0("BothNatVacImmLoss_simple_", parms[["timing"]])
}

if(parms[["simp"]] == "No") {
  write.csv(data_i,'BothNatVacImmLoss.csv')
} else{
  write.csv(data_i,paste0("BothNatVacImmLoss_simple_", parms[["timing"]] ,".csv"))
}

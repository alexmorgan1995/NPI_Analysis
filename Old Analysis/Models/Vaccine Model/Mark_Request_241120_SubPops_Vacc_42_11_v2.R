...
ggsave(pcomb, filename = "vacc_scenario_seq_42_270.png", dpi = 300, type = "cairo", width = 10, height = 14, units = "in")

#ggsave(p_noint_i, filename = "total_vacc_scenario_seq_42.png", dpi = 300, type = "cairo", width = 10, height = 10, units = "in")

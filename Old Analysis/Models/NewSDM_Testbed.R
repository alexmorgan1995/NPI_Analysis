...
ggplot(data = out, aes(x = time, y = I)) + theme_bw() + geom_line(size = 1.1, stat = "identity") 

ggplot(data = out, aes(x = time, y = beta)) + theme_bw() + geom_line(size = 1.1, stat = "identity") 

ggplot(data = out, aes(x = time, y = re)) + theme_bw() + geom_line(size = 1.1, stat = "identity") 
